...
from old_core.API.jikanpy.jikanpy.exceptions import APIException, ClientException, DeprecatedEndpoint
from old_core.API.jikanpy.jikanpy.parameters import (
    EXTENSIONS,
    SEARCH_PARAMS,
    SEASONS,
    DAYS,
